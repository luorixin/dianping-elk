...
import com.practice.dianping.controller.admin.AdminController;
...
public class ControllerAspect {
  ...
  @Around("execution(* com.practice.dianping.controller.admin.*.*(..)) && @annotation(org.springframework.web.bind.annotation.RequestMapping)")
