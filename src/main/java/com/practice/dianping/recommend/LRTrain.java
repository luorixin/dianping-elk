...
public class LRTrain {
  public static void main(String[] args) throws IOException {
    ...
    // 加载特征及label训练文件
    JavaRDD<String> csvFile = spark.read().textFile("file:///Users/SunXin/Documents/Practice/dianping/src/main/resources/feature.csv").toJavaRDD();
    ...
    JavaRDD<Row> rowJavaRDD = csvFile.map(new Function<String, Row>() {
      ...
      public Row call(String s) throws Exception {
        ...
        return RowFactory.create(new Double(strArr[11]), Vectors.dense(Double.valueOf(strArr[0]),Double.valueOf(strArr[1]),Double.valueOf(strArr[2]),
          Double.valueOf(strArr[3]),Double.valueOf(strArr[4]),Double.valueOf(strArr[5]),Double.valueOf(strArr[6]),
    ...
    lrModel.save("file:///Users/SunXin/Documents/Practice/dianping/src/main/resources/lrmodel");
