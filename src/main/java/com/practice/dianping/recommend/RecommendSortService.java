...
public class RecommendSortService {
  ...
  public void init(){
    ...
    lrModel = LogisticRegressionModel.load("file:///Users/SunXin/Documents/Practice/dianping/src/main/resources/lrmodel");

  }

  public List<Integer> sort(List<Integer> shopIdList, Integer userId){
    // 需要根据lrmode所需要11维的x，生产特征，然后调用预测方法
    List<ShopSortModel> list = new ArrayList<>();
    for (Integer shopId : shopIdList){
      // 造的假数据，可以从数据库或缓存中拿到对应的性别年龄评分价格等做特征转化生成feature
